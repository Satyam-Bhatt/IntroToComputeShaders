...
#ifndef PYRAMID_FACES_INCLUDED
#define PYRAMID_FACES_INCLUDED
...
struct DrawTriangle
{
    float3 normalWS; //normal in world space. All points share this notmal
...
// The system will create triangles out of each three consecutive verticies
VertexOutput Vertex(uint vertexID : SV_VertexID)
{
    ...
    // Since the buffer is structured in triangels, we need to divide the vertexID by three
    // to get the triangle, and then the modulo by 3 to get the vertex on the triangle
...
float4 Fragment(VertexOutput input) : SV_Target
{
    ...
    return 0;
#else
    // Initialize som information for the ligting function
